...
Under active development, please check for updates! ( [download the plugin ZIP file](https://github.com/stefaneichert/OpenLidarToolbox/raw/main/src/QGISplugin/open_lidar_tools.zip "Download Plugin as ZIP").)
...
The easiest way to install it, is to [download the plugin ZIP file](https://github.com/stefaneichert/OpenLidarToolbox/raw/main/src/QGISplugin/open_lidar_tools.zip "Download Plugin as ZIP").
