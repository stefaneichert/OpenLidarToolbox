...
class LidarPipeline(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterBoolean('GPD', 'GPD', optional=False, defaultValue=True))
        self.addParameter(QgsProcessingParameterBoolean('LVD', 'LVD', optional=False, defaultValue=True))
        self.addParameter(
        ...
        self.addParameter(QgsProcessingParameterBoolean('VisualisationOPN', 'Visualisation Openness', optional=False,
                                                        defaultValue=True))
        self.addParameter(
            QgsProcessingParameterBoolean('VisualisationDfME', 'Visualisation DME', optional=True, defaultValue=True))
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        feedback = QgsProcessingMultiStepFeedback(53, model_feedback)
        results = {}
        outputs = {}
        ...
        outputs['HybridInterpolation'] = processing.run('Open Lidar Tools:Hybrid Interpolation', alg_params,
    ...
    <p>This is an algorithm pipeline that takes an unclassified airborne LiDAR point cloud to produce all 
    derivatives essential for archaeology and anyone interested in visual analysis of LiDAR data.</p>
    
    <h2>Input parameters</h2>
    <h3>Input File</h3>
    <p>Unclassified point cloud in LAS or LAZ format. Noise classified as ASPRS class 7 will be exempt from the processing, all other preexisting classification will be ignored.</p>
    <h3>Source File Coordinate System</h3>
    <p>Select the Coordinate Reference System of the input LAS/LAZ file</p>
    <h3>Cell Size</h3>
    ...
    <p>The output layers are added to the map as temporary layers with specific names. They can be saved as files afterwards. In order to distinguish them from previously created files with the same tool a prefix can be defined</p>
    <h3>Outputs:</h3>
    <p><b>DFM: </b> Digital feature model, which is a type of DEM that combines ground and buildings</p>
    <p><b>GPD: </b>Ground Point Density</p>
    <p><b>LVD: </b>Low Vegetation Density</p>
